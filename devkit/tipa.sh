...
# 7z a -tzip DjInjection_$VERSION-$BUILD_NUMBER.tipa Payload
zip -qr DjInjection_$VERSION-$BUILD_NUMBER.tipa Payload
cd -

cp -p $THEOS_STAGING_DIR/DjInjection_$VERSION-$BUILD_NUMBER.tipa packages
